...
simulation1 = Simulation.new :node_count => 3, :packet_size => 10000, :flows_count => 100, :queue_settings => q1, :link_throughput => '0.05Mb', :cir => 100, :pir => 10000
simulation2 = Simulation.new :node_count => 3, :packet_size => 10000, :flows_count => 100, :queue_settings => q2, :link_throughput => '0.05Mb', :cir => 100, :pir => 10000
